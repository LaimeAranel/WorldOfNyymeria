package nymeriacraft.nymeriacraft.armor;
...
TAMINGSTONE("tamingstone", 28, new int[]{2, 5, 8, 3}, 19, SoundEvents.ARMOR_EQUIP_GOLD,
            2.0F, 0.0F, () -> Ingredient.of(ModItems.TAMINGSTONE.get()));
    ...
    public String getName() {
        return nymeriacraft.MODID + ":" + this.name;
    }
